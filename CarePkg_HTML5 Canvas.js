...
lib.ssMetadata = [
		...
		{name:"CarePkg_HTML5 Canvas_atlas_5", frames: [[0,0,1472,1954]]},
		{name:"CarePkg_HTML5 Canvas_atlas_6", frames: [[0,0,1974,1628]]},
		{name:"CarePkg_HTML5 Canvas_atlas_7", frames: [[0,0,1974,1858]]},
		{name:"CarePkg_HTML5 Canvas_atlas_8", frames: [[0,0,1872,1984]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},14).to({state:[{t:this.instance_2}]},7).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,x:-0.15,y:-69.95},14).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},14).to({_off:true,x:0,y:0},7).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},14).to({state:[{t:this.instance_2}]},7).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,x:-0.35,y:-69.7},14).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},14).to({_off:true,x:0,y:0},7).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},14).to({state:[{t:this.instance_2}]},7).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,y:-69.95},14).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},14).to({_off:true,y:0},7).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},14).to({state:[{t:this.instance_2}]},7).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,x:-0.15,y:-69.85},14).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},14).to({_off:true,x:0,y:0},7).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},14).to({state:[{t:this.instance_2}]},7).to({state:[]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,x:-0.35,y:-70.25},14).wait(9));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},14).to({_off:true,x:0,y:0},7).wait(2));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},14).to({state:[{t:this.instance_2}]},7).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,x:-0.35,y:-89.85},14).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},14).to({_off:true,x:0,y:0},7).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.insert2button).wait(1).to({mode:"independent"},0).wait(2));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-355.7,-847.5,711.4,847.5);
...
// stage content:
(lib.Carefolderopening4_HTML5Canvas = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.actionFrames = [60,84,94,119,129,154,164,189,199,224,234,259,269];
	// timeline functions:
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(60).call(this.frame_60).wait(24).call(this.frame_84).wait(10).call(this.frame_94).wait(25).call(this.frame_119).wait(10).call(this.frame_129).wait(25).call(this.frame_154).wait(10).call(this.frame_164).wait(25).call(this.frame_189).wait(10).call(this.frame_199).wait(25).call(this.frame_224).wait(10).call(this.frame_234).wait(25).call(this.frame_259).wait(10).call(this.frame_269).wait(11));

	// foreground_6
	this.insert6button = new lib.Tween19();
	this.insert6button.name = "insert6button";
	this.insert6button.setTransform(964.8,829);
	this.insert6button._off = true;
	new cjs.ButtonHelper(this.insert6button, 0, 1, 2, false, new lib.Tween19(), 3);

	this.timeline.addTween(cjs.Tween.get(this.insert6button).wait(249).to({_off:false},0).to({scaleX:1.15,scaleY:1.15,y:890.95},10).wait(1).to({scaleX:1,scaleY:1,y:829},4).to({_off:true},1).wait(15));

	// foreground_5
	this.insert5button = new lib.Tween16();
	this.insert5button.name = "insert5button";
	this.insert5button.setTransform(964.6,636.2);
	this.insert5button._off = true;
	new cjs.ButtonHelper(this.insert5button, 0, 1, 2, false, new lib.Tween16(), 3);

	this.timeline.addTween(cjs.Tween.get(this.insert5button).wait(214).to({_off:false},0).to({scaleX:1.15,scaleY:1.15,x:964.55,y:864.2},10).wait(1).to({scaleX:1,scaleY:1,x:964.6,y:636.2},4).to({_off:true},1).wait(50));

	// foreground_4
	this.insert4button = new lib.Tween13();
	this.insert4button.name = "insert4button";
	this.insert4button.setTransform(964.95,599.95);
	this.insert4button._off = true;
	new cjs.ButtonHelper(this.insert4button, 0, 1, 2, false, new lib.Tween13(), 3);

	this.timeline.addTween(cjs.Tween.get(this.insert4button).wait(179).to({_off:false},0).to({scaleX:1.15,scaleY:1.15,x:964.6,y:947.1},10).wait(1).to({scaleX:1,scaleY:1,x:964.95,y:599.95},4).to({_off:true},1).wait(85));

	// foreground_3
	this.insert3button = new lib.Tween10();
	this.insert3button.name = "insert3button";
	this.insert3button.setTransform(964.85,565);
	this.insert3button._off = true;
	new cjs.ButtonHelper(this.insert3button, 0, 1, 2, false, new lib.Tween10(), 3);

	this.timeline.addTween(cjs.Tween.get(this.insert3button).wait(144).to({_off:false},0).to({scaleX:1.15,scaleY:1.15,y:895.05},10).wait(1).to({scaleX:1,scaleY:1,y:565},4).to({_off:true},1).wait(120));

	// foreground_2
	this.instance = new lib.Tween7("synched",0);
	this.instance.setTransform(964.65,515);
	this.instance._off = true;

	this.insert2goBack = new lib.Tween7("synched",0);
	this.insert2goBack.name = "insert2goBack";
	this.insert2goBack.setTransform(964.6,852.25,1.15,1.15);
	this.insert2goBack._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(109).to({_off:false},0).to({_off:true,scaleX:1.15,scaleY:1.15,x:964.6,y:852.25},10).wait(161));
	this.timeline.addTween(cjs.Tween.get(this.insert2goBack).wait(109).to({_off:false},10).wait(1).to({startPosition:0},0).to({scaleX:1,scaleY:1,x:964.65,y:518.25},4).to({_off:true},1).wait(155));

	// foreground_1
	this.instance_1 = new lib.insert1_1();
	this.instance_1.setTransform(964.65,476.8,1,1,0,0,0,0,-460.2);
	this.instance_1._off = true;
	new cjs.ButtonHelper(this.instance_1, 0, 1, 1);

	this.insert1goBack = new lib.insert1_1();
	this.insert1goBack.name = "insert1goBack";
	this.insert1goBack.setTransform(964.65,810.05,1.15,1.15,0,0,0,0,-460.2);
	this.insert1goBack._off = true;
	new cjs.ButtonHelper(this.insert1goBack, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(74).to({_off:false},0).to({_off:true,scaleX:1.15,scaleY:1.15,y:810.05},10).wait(196));
	this.timeline.addTween(cjs.Tween.get(this.insert1goBack).wait(74).to({_off:false},10).wait(1).to({scaleX:1,scaleY:1,y:476.8},4).to({_off:true},1).wait(190));

	// right_panel
	this.instance_2 = new lib.outright();
	this.instance_2.setTransform(964,437,0.5,0.5);
	...
	this.shape.setTransform(1148.5,926);
	...
	this.shape_1.setTransform(1161.5,924.325);
	...
	this.shape_2.setTransform(1174.475,922.675);
	...
	this.shape_3.setTransform(1187.475,921);
	...
	sprImg_shape_4.onload = function(){
		this.shape_4.graphics.bf(sprImg_shape_4, null, new cjs.Matrix2D(0.359,0.018,0,0.5,-132.5,-495.7)).s().p("EgUsBLXMAAAiYzMApZACGMAAACYzg")
	}.bind(this);
	this.shape_4.setTransform(1200.45,919.325);
	...
	this.shape_5.setTransform(1213.425,917.65);
	...
	this.shape_6.setTransform(1226.425,916);
	...
	this.shape_7.setTransform(1239.4,914.325);
	...
	this.shape_8.setTransform(1252.4,912.675);
	...
	this.shape_9.setTransform(1265.375,911);
	...
	sprImg_shape_10.onload = function(){
		this.shape_10.graphics.bf(sprImg_shape_10, null, new cjs.Matrix2D(0.148,0.045,0,0.5,-54.6,-505.7)).s().p("EgIhBJzMAAAiYzIRDFOMAAACYzg")
	}.bind(this);
	this.shape_10.setTransform(1278.35,909.325);
	...
	sprImg_shape_11.onload = function(){
		this.shape_11.graphics.bf(sprImg_shape_11, null, new cjs.Matrix2D(0.113,0.05,0,0.5,-41.6,-507.3)).s().p("EgGgBJjMAAAiYzINAFuMAAACYzg")
	}.bind(this);
	this.shape_11.setTransform(1291.35,907.675);
	...
	this.shape_12.setTransform(1304.325,906);
	...
	this.shape_13.setTransform(1317.325,904.35);
	...
	this.shape_14.setTransform(1330.3,902.675);
	...
	this.shape_15.setTransform(1334.125,902.675);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2}]}).to({state:[{t:this.shape}]},29).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[]},1).wait(235));
	...
	sprImg_shape_16.onload = function(){
		this.shape_16.graphics.bf(sprImg_shape_16, null, new cjs.Matrix2D(0.006,-0.065,0,0.5,-2.1,-465)).s().p("EgAThIpIAnngMAAACYzIgnHgg")
	}.bind(this);
	this.shape_16.setTransform(1334.3,902.05);
	...
	this.shape_17.setTransform(1341.8,902.05);
	...
	this.shape_18.setTransform(1350.425,902.05);
	...
	this.shape_19.setTransform(1363.25,903.9);
	...
	this.shape_20.setTransform(1376.05,905.75);
	...
	this.shape_21.setTransform(1388.875,907.575);
	...
	this.shape_22.setTransform(1401.675,909.425);
	...
	sprImg_shape_23.onload = function(){
		this.shape_23.graphics.bf(sprImg_shape_23, null, new cjs.Matrix2D(0.221,-0.04,0,0.5,-81.5,-474.2)).s().p("EgMthKFIZckoMAAACYzI5cEog")
	}.bind(this);
	this.shape_23.setTransform(1414.5,911.275);
	...
	this.shape_24.setTransform(1427.325,913.125);
	...
	this.shape_25.setTransform(1440.1,914.925);
	...
	this.shape_26.setTransform(1452.925,916.775);
	...
	sprImg_shape_27.onload = function(){
		this.shape_27.graphics.bf(sprImg_shape_27, null, new cjs.Matrix2D(0.361,-0.02,0,0.5,-132.7,-481.6)).s().p("EgUvhLPMApegCUMAAACYzMgpeACUg")
	}.bind(this);
	this.shape_27.setTransform(1465.75,918.625);
	...
	sprImg_shape_28.onload = function(){
		this.shape_28.graphics.bf(sprImg_shape_28, null, new cjs.Matrix2D(0.396,-0.015,0,0.5,-145.5,-483.5)).s().p("EgWvhLiMAtegBuMAAACYzMgteABug")
	}.bind(this);
	this.shape_28.setTransform(1478.55,920.475);
	...
	this.shape_29.setTransform(1491.375,922.3);
	...
	this.shape_30.setTransform(1504.175,924.15);
	...
	this.shape_32.setTransform(780.5,926);
	...
	this.shape_33.setTransform(766.7,924.225);
	...
	this.shape_34.setTransform(752.925,922.45);
	...
	this.shape_35.setTransform(739.125,920.7);
	...
	this.shape_36.setTransform(725.375,918.925);
	...
	this.shape_37.setTransform(711.575,917.15);
	...
	this.shape_38.setTransform(697.775,915.375);
	...
	sprImg_shape_39.onload = function(){
		this.shape_39.graphics.bf(sprImg_shape_39, null, new cjs.Matrix2D(0.474,-0.064,0,1,-86.9,-477.3)).s().p("EgNkhKkIbJjqMAAACYzI7JDqg")
	}.bind(this);
	this.shape_39.setTransform(684,913.625);
	...
	this.shape_40.setTransform(670.2,911.85);
	...
	sprImg_shape_41.onload = function(){
		this.shape_41.graphics.bf(sprImg_shape_41, null, new cjs.Matrix2D(0.323,-0.082,0,1,-59.3,-474)).s().p("EgJQhKDISiksMAAACYzIyiEsg")
	}.bind(this);
	this.shape_41.setTransform(656.4,910.075);
	...
	sprImg_shape_42.onload = function(){
		this.shape_42.graphics.bf(sprImg_shape_42, null, new cjs.Matrix2D(0.248,-0.091,0,1,-45.6,-472.3)).s().p("EgHHhJyIOPlOMAAACYzIuPFOg")
	}.bind(this);
	this.shape_42.setTransform(642.65,908.3);
	...
	sprImg_shape_43.onload = function(){
		this.shape_43.graphics.bf(sprImg_shape_43, null, new cjs.Matrix2D(0.173,-0.1,0,1,-31.8,-470.6)).s().p("EgE9hJiIJ6luMAAACYyIp6Fwg")
	}.bind(this);
	this.shape_43.setTransform(628.85,906.55);
	...
	this.shape_44.setTransform(615.075,904.775);
	...
	this.shape_45.setTransform(601.275,903);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3}]}).to({state:[{t:this.shape_32}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_34}]},1).to({state:[{t:this.shape_35}]},1).to({state:[{t:this.shape_36}]},1).to({state:[{t:this.shape_37}]},1).to({state:[{t:this.shape_38}]},1).to({state:[{t:this.shape_39}]},1).to({state:[{t:this.shape_40}]},1).to({state:[{t:this.shape_41}]},1).to({state:[{t:this.shape_42}]},1).to({state:[{t:this.shape_43}]},1).to({state:[{t:this.shape_44}]},1).to({state:[{t:this.shape_45}]},1).to({state:[]},1).wait(265));
	...
	this.shape_46.setTransform(599.775,905.575);
	...
	this.shape_47.setTransform(587.575,906.85);
	...
	this.shape_48.setTransform(574.05,906.825);
	...
	sprImg_shape_49.onload = function(){
		this.shape_49.graphics.bf(sprImg_shape_49, null, new cjs.Matrix2D(0.096,0.047,0,0.5,-35.4,-504.7)).s().p("EgFhBJfMAAAiYWILDFaMAAACYVg")
	}.bind(this);
	this.shape_49.setTransform(561.7,908.15);
	...
	this.shape_50.setTransform(549.35,909.5);
	...
	this.shape_51.setTransform(537,910.825);
	...
	this.shape_52.setTransform(524.65,912.175);
	...
	sprImg_shape_53.onload = function(){
		this.shape_53.graphics.bf(sprImg_shape_53, null, new cjs.Matrix2D(0.231,0.031,0,0.5,-84.7,-499)).s().p("EgNOBKYMAAAiYVIaeDmMAAACYVg")
	}.bind(this);
	this.shape_53.setTransform(512.3,913.5);
	...
	this.shape_54.setTransform(499.95,914.825);
	...
	this.shape_55.setTransform(487.6,916.15);
	...
	sprImg_shape_56.onload = function(){
		this.shape_56.graphics.bf(sprImg_shape_56, null, new cjs.Matrix2D(0.332,0.02,0,0.5,-121.8,-494.7)).s().p("EgTABLDMAAAiYVMAmBACQMAAACYVg")
	}.bind(this);
	this.shape_56.setTransform(475.25,917.475);
	...
	this.shape_57.setTransform(462.9,918.8);
	...
	sprImg_shape_58.onload = function(){
		this.shape_58.graphics.bf(sprImg_shape_58, null, new cjs.Matrix2D(0.399,0.012,0,0.5,-146.4,-491.8)).s().p("EgW3BLgMAAAiYVMAtvABWMAAACYVg")
	}.bind(this);
	this.shape_58.setTransform(450.55,920.15);
	...
	this.shape_59.setTransform(438.2,921.475);
	...
	sprImg_shape_60.onload = function(){
		this.shape_60.graphics.bf(sprImg_shape_60, null, new cjs.Matrix2D(0.466,0.004,0,0.5,-171.1,-488.9)).s().p("EgavBL9MAAAiYVMA1eAAcMAAACYVg")
	}.bind(this);
	this.shape_60.setTransform(425.85,922.825);
	...
	this.shape_61.setTransform(413.5,924.15);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_46}]},14).to({state:[{t:this.shape_47}]},1).to({state:[{t:this.shape_48}]},1).to({state:[{t:this.shape_49}]},1).to({state:[{t:this.shape_50}]},1).to({state:[{t:this.shape_51}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_53}]},1).to({state:[{t:this.shape_54}]},1).to({state:[{t:this.shape_55}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_57}]},1).to({state:[{t:this.shape_58}]},1).to({state:[{t:this.shape_59}]},1).to({state:[{t:this.shape_60}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_61}]},31).to({state:[]},210).wait(10));

	// pocket
	this.instance_4 = new lib.pocket();
	this.instance_4.setTransform(599,1088,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(60).to({_off:true},1).wait(3).to({_off:false},0).to({_off:true},206).wait(10));

	// move_up_6
	this.instance_5 = new lib.insert1();
	this.instance_5.setTransform(609,913,0.3602,0.3602);

	this.insert6btn = new lib.insert6button();
	this.insert6btn.name = "insert6btn";
	this.insert6btn.setTransform(964.8,1163.95,1,1,0,0,0,0,-251.1);
	new cjs.ButtonHelper(this.insert6btn, 0, 1, 1);

	this.insert6button_1 = new lib.Tween19();
	this.insert6button_1.name = "insert6button_1";
	this.insert6button_1.setTransform(964.8,1164);
	this.insert6button_1._off = true;
	new cjs.ButtonHelper(this.insert6button_1, 0, 1, 2, false, new lib.Tween19(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5}]}).to({state:[{t:this.insert6btn}]},60).to({state:[]},1).to({state:[{t:this.insert6button_1}]},3).to({state:[{t:this.insert6button_1}]},175).to({state:[{t:this.insert6button_1}]},10).to({state:[]},1).to({state:[{t:this.insert6button_1}]},14).to({state:[{t:this.insert6button_1}]},5).to({state:[]},1).wait(10));
	this.timeline.addTween(cjs.Tween.get(this.insert6button_1).wait(64).to({_off:false},0).wait(175).to({y:829},10).to({_off:true},1).wait(14).to({_off:false},0).to({y:1164},5).to({_off:true},1).wait(10));

	// move_up_5
	this.instance_6 = new lib.insert2();
	this.instance_6.setTransform(609,829,0.3603,0.3603);

	this.insert5btn = new lib.insert5button();
	this.insert5btn.name = "insert5btn";
	this.insert5btn.setTransform(964.6,1122.3,1,1,0,0,0,0,-293.3);
	new cjs.ButtonHelper(this.insert5btn, 0, 1, 1);

	this.insert5button_1 = new lib.Tween16();
	this.insert5button_1.name = "insert5button_1";
	this.insert5button_1.setTransform(964.6,1122.3);
	this.insert5button_1._off = true;
	new cjs.ButtonHelper(this.insert5button_1, 0, 1, 2, false, new lib.Tween16(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6}]}).to({state:[{t:this.insert5btn}]},60).to({state:[]},1).to({state:[{t:this.insert5button_1}]},3).to({state:[{t:this.insert5button_1}]},140).to({state:[{t:this.insert5button_1}]},10).to({state:[]},1).to({state:[{t:this.insert5button_1}]},14).to({state:[{t:this.insert5button_1}]},5).to({state:[]},36).wait(10));
	this.timeline.addTween(cjs.Tween.get(this.insert5button_1).wait(64).to({_off:false},0).wait(140).to({y:636.2},10).to({_off:true},1).wait(14).to({_off:false},0).to({y:1122.3},5).to({_off:true},36).wait(10));

	// move_up_4
	this.instance_7 = new lib.insert3();
	this.instance_7.setTransform(609,745,0.3607,0.3607);

	this.insert4btn = new lib.insert4button();
	this.insert4btn.name = "insert4btn";
	this.insert4btn.setTransform(964.95,1080.2,1,1,0,0,0,0,-334.9);
	new cjs.ButtonHelper(this.insert4btn, 0, 1, 1);

	this.insert4button_1 = new lib.Tween13();
	this.insert4button_1.name = "insert4button_1";
	this.insert4button_1.setTransform(964.95,1080.05);
	this.insert4button_1._off = true;
	new cjs.ButtonHelper(this.insert4button_1, 0, 1, 2, false, new lib.Tween13(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_7}]}).to({state:[{t:this.insert4btn}]},60).to({state:[]},1).to({state:[{t:this.insert4button_1}]},3).to({state:[{t:this.insert4button_1}]},105).to({state:[{t:this.insert4button_1}]},10).to({state:[]},1).to({state:[{t:this.insert4button_1}]},14).to({state:[{t:this.insert4button_1}]},5).to({state:[]},71).wait(10));
	this.timeline.addTween(cjs.Tween.get(this.insert4button_1).wait(64).to({_off:false},0).wait(105).to({y:599.95},10).to({_off:true},1).wait(14).to({_off:false},0).to({y:1080.05},5).to({_off:true},71).wait(10));

	// move_up_3
	this.instance_8 = new lib.insert4();
	this.instance_8.setTransform(609,661,0.3802,0.3802);

	this.insert3btn = new lib.insert3button();
	this.insert3btn.name = "insert3btn";
	this.insert3btn.setTransform(964.85,1038.05,1,1,0,0,0,0,-377.2);
	new cjs.ButtonHelper(this.insert3btn, 0, 1, 1);

	this.insert3button_1 = new lib.Tween10();
	this.insert3button_1.name = "insert3button_1";
	this.insert3button_1.setTransform(964.85,1038.1);
	this.insert3button_1._off = true;
	new cjs.ButtonHelper(this.insert3button_1, 0, 1, 2, false, new lib.Tween10(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8}]}).to({state:[{t:this.insert3btn}]},60).to({state:[]},1).to({state:[{t:this.insert3button_1}]},3).to({state:[{t:this.insert3button_1}]},70).to({state:[{t:this.insert3button_1}]},10).to({state:[]},1).to({state:[{t:this.insert3button_1}]},14).to({state:[{t:this.insert3button_1}]},5).to({state:[]},106).wait(10));
	this.timeline.addTween(cjs.Tween.get(this.insert3button_1).wait(64).to({_off:false},0).wait(70).to({y:565},10).to({_off:true},1).wait(14).to({_off:false},0).to({y:1038.1},5).to({_off:true},106).wait(10));

	// move_up_2_
	this.instance_9 = new lib.insert5();
	this.instance_9.setTransform(609,578,0.38,0.38);

	this.insert2btn = new lib.insert2button();
	this.insert2btn.name = "insert2btn";
	this.insert2btn.setTransform(964.65,996.65,1,1,0,0,0,0,-418.8);
	new cjs.ButtonHelper(this.insert2btn, 0, 1, 2);

	this.insert2button = new lib.Tween7();
	this.insert2button.name = "insert2button";
	this.insert2button.setTransform(964.65,996.7);
	this.insert2button._off = true;
	new cjs.ButtonHelper(this.insert2button, 0, 1, 2, false, new lib.Tween7(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_9}]}).to({state:[{t:this.insert2btn}]},60).to({state:[]},1).to({state:[{t:this.insert2button}]},3).to({state:[{t:this.insert2button}]},35).to({state:[{t:this.insert2button}]},10).to({state:[]},1).to({state:[{t:this.insert2button}]},14).to({state:[{t:this.insert2button}]},5).to({state:[]},141).wait(10));
	this.timeline.addTween(cjs.Tween.get(this.insert2button).wait(64).to({_off:false},0).wait(35).to({y:515},10).to({_off:true},1).wait(14).to({_off:false,y:518.25},0).to({y:996.7},5).to({_off:true},141).wait(10));

	// move_up_1
	this.instance_10 = new lib.insert6();
	this.instance_10.setTransform(609,495,0.38,0.38);

	this.insert1btn = new lib.insert1_1();
	this.insert1btn.name = "insert1btn";
	this.insert1btn.setTransform(964.65,955.1,1,1,0,0,0,0,-460.2);
	this.insert1btn._off = true;
	new cjs.ButtonHelper(this.insert1btn, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10}]}).to({state:[{t:this.insert1btn}]},60).to({state:[]},1).to({state:[{t:this.insert1btn}]},3).to({state:[{t:this.insert1btn}]},10).to({state:[]},1).to({state:[{t:this.insert1btn}]},14).to({state:[{t:this.insert1btn}]},5).to({state:[]},176).wait(10));
	this.timeline.addTween(cjs.Tween.get(this.insert1btn).wait(60).to({_off:false},0).to({_off:true},1).wait(3).to({_off:false},0).to({y:476.8},10).to({_off:true},1).wait(14).to({_off:false},0).to({y:955.1},5).to({_off:true},176).wait(10));

	// back
	this.instance_11 = new lib.insidecenter();
	this.instance_11.setTransform(597,437,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(60).to({_off:true},210).wait(10));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,1701,1419.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/insert5.jpg?1695717075684", id:"insert5"},
		{src:"images/insert6.jpg?1695717075684", id:"insert6"},
		{src:"images/CarePkg_HTML5 Canvas_atlas_1.png?1695717075624", id:"CarePkg_HTML5 Canvas_atlas_1"},
		{src:"images/CarePkg_HTML5 Canvas_atlas_2.png?1695717075624", id:"CarePkg_HTML5 Canvas_atlas_2"},
		{src:"images/CarePkg_HTML5 Canvas_atlas_3.png?1695717075624", id:"CarePkg_HTML5 Canvas_atlas_3"},
		{src:"images/CarePkg_HTML5 Canvas_atlas_4.png?1695717075624", id:"CarePkg_HTML5 Canvas_atlas_4"},
		{src:"images/CarePkg_HTML5 Canvas_atlas_5.png?1695717075624", id:"CarePkg_HTML5 Canvas_atlas_5"},
		{src:"images/CarePkg_HTML5 Canvas_atlas_6.png?1695717075624", id:"CarePkg_HTML5 Canvas_atlas_6"},
		{src:"images/CarePkg_HTML5 Canvas_atlas_7.png?1695717075624", id:"CarePkg_HTML5 Canvas_atlas_7"},
		{src:"images/CarePkg_HTML5 Canvas_atlas_8.png?1695717075624", id:"CarePkg_HTML5 Canvas_atlas_8"}
	],
	preloads: []
};
